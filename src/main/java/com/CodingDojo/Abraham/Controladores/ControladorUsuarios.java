...
public class ControladorUsuarios {
	...
	@GetMapping("/dashboard") // <==== Esta es la lista de usuarios
	...
	public String nuevaDireccion(Model model) {
		...
		List<Usuario> usuarios = servicio.buscarUsuariosSinDireccion();
		model.addAttribute("usuarios", usuarios);
	...
	@DeleteMapping("/delete/{usuarioId}/{direccionId}")
	public String deleteUsuarioAndDireccion(@PathVariable("usuarioId")Long usuarioId, @PathVariable("direccionId")Long direccionId) {
		servicio.deleteUsuarioAndDireccion(usuarioId, direccionId);
		return "redirect:/dashboard";
	}
}
